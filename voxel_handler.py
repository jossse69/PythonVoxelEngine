...
class VoxelHandler:
    def __init__(self, world):
        ...
        self.world_local_pos = None
        self.voxel_normal = None

        self.interaction_mode = 0 # 0 to remove voxels, 1 to place new ones
        self.new_voxel_id = 1
    ...
    def ray_cast(self):
        ...
        # end point
        x2, y2, z2 = self.game.player.position + self.game.player.front * MAX_RAY_DIST
    ...
    def get_voxel_id(self, voxel_world_pos):
        ...
        if 0 <= cx < WORLD_WIDTH and 0 <= cy < WORLD_HEIGHT and 0 <= cz < WORLD_D:
